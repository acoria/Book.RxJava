...
public class FileBrowserActivity_beforeVM extends AppCompatActivity {

    final static String TAG = FileBrowserActivity_beforeVM.class.getSimpleName();
    ListView listView;
    ...
    private void initWithPermissions() {
        ...
        Observable<File> fileChangeObservable =
                Observable.merge(
                        listItemClickObservable,
                        fileNavigateBackEventObservable,
                        rootButtonObservable);
        compositeDisposable.add(fileChangeObservable.subscribe(selectedDir::onNext));
    }
